...
public class JOption {
	public static void main(String[] args) {
		...
		String[] responds= {"No, you are aewsome", "Thank You!", "Blush","Search id"};
		JOptionPane.showOptionDialog(null,"Choose a function", "This is my title",JOptionPane.YES_NO_CANCEL_OPTION,JOptionPane.PLAIN_MESSAGE,icon,responds, null);
